...
colnames(coriell)
head(coriell)
#### colnames() shows the description of each column's value
#### head() is a handy method to show first 6 lines of the table
...
#### Writing functions avoids copy/pasting code, which helps avoiding error.
