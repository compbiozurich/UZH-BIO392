...
The higher the PC number the less important is the variance, so the most meaningful are the PC1 and PC2 wich explains the first and second most variance. 
